...
public class enviar_proveedor_credito_compra extends javax.swing.JFrame {
    int Select;
    String telefono,cedula,nombres,apellidos,direccion;
    
    public enviar_proveedor_credito_compra() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD", "PROVEEDOR", "DIRECCION", "TELEFONO", "CUIT"
            }
        ) {
        ...
        jLabel2.setText("PROVEEDORES CON CREDITO");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 30, 410, 50));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila>=0){
            ...
            Consultar_Credito_Compras.txtCodigoProveedor.setText(codigoCliente);
            Consultar_Credito_Compras.comboProveedor.setSelectedItem(nombreCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enviar_proveedor_credito_compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enviar_proveedor_credito_compra().setVisible(true);
            }
        });
    }
