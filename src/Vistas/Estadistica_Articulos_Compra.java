...
public class Estadistica_Articulos_Compra extends javax.swing.JDialog {
    int Select,bandera;
    String fecha1,fecha2,diaG,mesG,añoG,fechaG, añoHasta,añoDesde;
    double total,totalArticulos;

    public Estadistica_Articulos_Compra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarTablaFacturas22(){
        try{
            ...
            tabla2.setRowSorter(new TableRowSorter(modelo));
            modelo.setNumRows(0);
            ResultSet r2= consulta.executeQuery("SELECT SUM(referencia_compra.cantidad), referencia_compra.codigo_producto as 'Cantidad Comprada' from referencia_compra , compra WHERE compra.cod_compra=referencia_compra.cod_compra AND compra.fecha BETWEEN '"+fecha1+"' and '"+fecha2+"' GROUP by referencia_compra.codigo_producto ORDER BY SUM(referencia_compra.cantidad) ASC");
            while(r2.next()){  
                modelo.addRow( new Object [] {null,null,null}); 
                tabla2.setValueAt(Double.parseDouble(r2.getString(1)),i,2);
    ...
    public void cargarTablaFacturasMes22(){
        try{
            ...
            tabla2.setRowSorter(new TableRowSorter(modelo));
            modelo.setNumRows(0);
            ResultSet r2= consulta.executeQuery("SELECT SUM(referencia_compra.cantidad), referencia_compra.codigo_producto as 'Cantidad Comprada' from referencia_compra , compra WHERE compra.cod_compra=referencia_compra.cod_compra AND MONTH(compra.fecha) >='"+fecha1+"'  and YEAR(compra.fecha) >='"+añoDesde+"' AND MONTH(compra.fecha) <='"+fecha2+"'  and YEAR(compra.fecha) <='"+añoHasta+"' GROUP by referencia_compra.codigo_producto ORDER BY SUM(referencia_compra.cantidad) ASC");
            while(r2.next()){  
                modelo.addRow( new Object [] {null,null,null}); 
                tabla2.setValueAt(Double.parseDouble(r2.getString(1)),i,2);
                ResultSet r22= consulta2.executeQuery("SELECT referencia from articulo WHERE cod_articulo='"+r2.getString(2)+"'");
    ...
    public void graficarArticulos(){
        ...
        JFreeChart ch =ChartFactory.createPieChart("ARTÍCULOS MÁS COMPRADOS", dtsc,true, true, false);
        ChartPanel cp= new ChartPanel(ch);
        panelEstadistica.add(cp);
        cp.setBounds(0,0,550,400);
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("RANKING DE ARTÍCULOS COMPRA");
        ...
        tabla2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "POSICION", "ARTICULO", "CANT COMPRADA"
            }
        ) {
        ...
        jLabel7.setText("Total Artículos Comprados");
        panelEsta.add(jLabel7);
        jLabel7.setBounds(100, 180, 280, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estadistica_Articulos_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Estadistica_Articulos_Compra dialog = new Estadistica_Articulos_Compra(new javax.swing.JFrame(), true);
