...
public class Consultar_Cierre_Caja extends javax.swing.JFrame {
    int Select;
    String nombreCaja,codCaja,fechaApertura,horaApertura,cajaInicial,codigoCaja;

    public Consultar_Cierre_Caja() {
        initComponents();
        ...
        tabla1.getTableHeader().getColumnModel().getColumn(2).setMaxWidth(200);
        tabla1.getTableHeader().getColumnModel().getColumn(2).setMaxWidth(200);
        ...
        tabla1.getColumnModel().getColumn(5).setMaxWidth(120);
        tabla1.getColumnModel().getColumn(5).setMinWidth(120);
        tabla1.getTableHeader().getColumnModel().getColumn(5).setMaxWidth(120);
        tabla1.getTableHeader().getColumnModel().getColumn(5).setMaxWidth(120);
        ...
        try{
            ...
            ResultSet r= consulta.executeQuery("select cod_cierre,cod_caja,nombre_caja,vendedor,fecha,hora,total_caja FROM cierre_caja ORDER BY cod_cierre");
            int i,j;
            i=0;
            j=0;
            ...
            while(r.next()){
                ...
                tabla1.setValueAt(empleado,i,3);
                ...
                String str="";
                double value = Double.parseDouble(r.getString(7));
                myFormatter = new DecimalFormat(pattern);
                str = myFormatter.format(value);
                if(str.equals(",00")){
                        str="0,00";
                }
                tabla1.setValueAt(str,i,6);
                i++;
            }
            r.close();
    ...
    private void initComponents() {
        ...
        MostrarCierre = new javax.swing.JMenuItem();
        ...
        MostrarCierre.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        MostrarCierre.setText("Mostrar cierre de caja");
        MostrarCierre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MostrarCierreActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MostrarCierre);
        ...
        tabla1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD", "COD CAJA", "NOMBRE CAJA", "NOMBRE VENDEDOR", "FECHA", "HORA", "CAJA FINAL"
            }
        ) {
        ...
        panelImage1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 101, 1050, 570));
        panelImage1.add(txt_recibe, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 690, 37, -1));
        ...
        jLabel9.setText("CIERRES DE CAJA");
        ...
        panelImage1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 20, 50, 50));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila>=0){
            ...
            codigoCaja= tabla1.getValueAt(Select,1).toString();
        }
    ...
    private void MostrarCierreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MostrarCierreActionPerformed
        int fila= tabla1.getSelectedRow();
        if(fila>=0){
            Select=tabla1.getSelectedRow();
            codigoCaja= tabla1.getValueAt(Select,1).toString();
    ...
    }//GEN-LAST:event_MostrarCierreActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Cierre_Caja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_Cierre_Caja().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem MostrarCierre;
