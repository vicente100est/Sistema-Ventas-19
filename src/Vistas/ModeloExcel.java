...
public class ModeloExcel {
    ...
    public String Importar(File archivo, JTable tablaD) throws FileNotFoundException, IOException{
        String respuesta="No se pudo realizar la importación.";
        DefaultTableModel modeloT = new DefaultTableModel();
        tablaD.setModel(modeloT);
        //tablaD.setAutoResizeMode(JTable.AUTO_RESIZE_OFF); //Ajustael tamaño de la nueva tabla
        try {
