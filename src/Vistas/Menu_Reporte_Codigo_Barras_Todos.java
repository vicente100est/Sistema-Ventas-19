...
public class Menu_Reporte_Codigo_Barras_Todos extends javax.swing.JFrame {

    public Menu_Reporte_Codigo_Barras_Todos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("DE TODOS LOS ARTICULOS");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{   
            String reporte="codigoBarras.jasper";
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Connection miconexion = conexion.ObtenerConexion();    
        try{   
            String reporte="codigoBarrasX2.jasper";
            JasperPrint informe =JasperFillManager.fillReport(reporte,null,miconexion);
            JasperViewer ventanavisor=new JasperViewer(informe,false);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        Connection miconexion = conexion.ObtenerConexion();    
        try{   
            String reporte="codigoBarrasX8.jasper";
            JasperPrint informe =JasperFillManager.fillReport(reporte,null,miconexion);
            JasperViewer ventanavisor=new JasperViewer(informe,false);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        Connection miconexion = conexion.ObtenerConexion();    
        try{   
            String reporte="codigoBarrasX4.jasper";
            JasperPrint informe =JasperFillManager.fillReport(reporte,null,miconexion);
            JasperViewer ventanavisor=new JasperViewer(informe,false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Reporte_Codigo_Barras_Todos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Reporte_Codigo_Barras_Todos().setVisible(true);
            }
        });
    }
