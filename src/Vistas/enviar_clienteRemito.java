...
public class enviar_clienteRemito extends javax.swing.JFrame {
    int Select;
    String telefono,cedula,nombres,apellidos,direccion;
    
    public enviar_clienteRemito() {
        initComponents();
        ...
        try{
            ...
            ResultSet r= consulta.executeQuery("select c.cod_cliente, c.nombres, c.dirrecion, c.localidad, c.telefono, c.cuit from cliente c, remito r where c.cod_cliente=r.cod_cliente AND c.cod_cliente>0 AND r.cod_remito>0 AND r.cod_cliente>0 AND r.condicion='NO FACTURADO' group by r.cod_cliente");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 980, 540));
        ...
        jPanel1.add(enviar, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 650, -1, 30));
        ...
        jPanel1.add(btnVerFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 650, -1, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 50, 50));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 32)); // NOI18N
        jLabel2.setText("CLIENTES CORRIENTES");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 40, 380, 50));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila>=0){
            ...
            Modulo_Saldos.txtCodigoCliente1.setText(codigoCliente);
            Modulo_Saldos.comboCliente.setSelectedItem(nombreCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enviar_clienteRemito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enviar_clienteRemito().setVisible(true);
            }
        });
    }
