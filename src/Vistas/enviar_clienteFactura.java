...
public class enviar_clienteFactura extends javax.swing.JFrame {
    ...
    public enviar_clienteFactura() {
        ...
        try{
            ...
            ResultSet r= consulta.executeQuery("select c.cod_cliente, c.nombres, c.dirrecion, c.localidad, c.telefono, c.cuit from cliente c, factura f where c.cod_cliente=f.cod_cliente AND c.cod_cliente>0 group by f.cod_cliente");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 980, 560));
        ...
        jPanel1.add(enviar, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 670, -1, 30));
        ...
        jPanel1.add(btnVerFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 670, -1, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 30, 50, 50));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 32)); // NOI18N
        jLabel2.setText("FACTURACIÓN DE CLIENTES");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 30, 380, 50));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila>=0){
            ...
            this.dispose();
            frm_clientes_factura_por_fecha repor = new frm_clientes_factura_por_fecha();
            repor .setVisible(true);
            repor.setLocationRelativeTo(this);
            repor.recibeCliente.setText(codigoCliente);
            repor.nombreCliente.setText(nombreCliente);
