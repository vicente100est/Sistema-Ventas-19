...
public class enviar_cliente_credito_venta extends javax.swing.JFrame {
    int Select;
    String telefono,cedula,nombres,apellidos,direccion;
    
    public enviar_cliente_credito_venta() {
        initComponents();
        ...
        try{
            ...
            ResultSet r= consulta.executeQuery("select c.cod_cliente, c.nombres, c.dirrecion, c.localidad, c.telefono, c.cuit from cliente c, factura f where c.cod_cliente=f.cod_cliente AND c.cod_cliente>0 AND f.cod_factura>0 AND f.cod_cliente>0 AND f.condicion='ACTIVA' AND f.tipo_pago='CREDITO' group by f.cod_cliente");
            ...
            while(r.next()){
                ...
                tabla1.setValueAt(r.getString(1),i,0); //codigo cliente
                tabla1.setValueAt(r.getString(2),i,1);//nombre cliente
                tabla1.setValueAt(r.getString(3)+", "+r.getString(4),i,2);//direccion y localidad cliente
                tabla1.setValueAt(r.getString(5),i,3);//telefono cliente
                tabla1.setValueAt(r.getString(6),i,4);//cuit cliente
                i++;
    ...
    private void initComponents() {
        ...
        tabla1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD", "CLIENTE", "DIRECCION", "TELEFONO", "CUIT"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 1100, 560));
        ...
        jPanel1.add(enviar, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 670, -1, 30));
        ...
        jPanel1.add(btnVerFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 670, -1, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 30, 50, 50));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 32)); // NOI18N
        jLabel2.setText("CLIENTES CON CREDITO");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 30, 380, 50));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila>=0){
            ...
            String nombreCliente= tabla1.getValueAt(Select,1).toString();
            Consultar_Credito_Ventas.txtCodigoCliente1.setText(codigoCliente);
            Consultar_Credito_Ventas.comboCliente.setSelectedItem(nombreCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enviar_cliente_credito_venta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enviar_cliente_credito_venta().setVisible(true);
            }
        });
    }
