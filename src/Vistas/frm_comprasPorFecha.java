 ...
 * @author Hugo
 */
public class frm_comprasPorFecha extends javax.swing.JFrame {

    /**
     * Creates new form frm_facturasPorFecha
     */
    public frm_comprasPorFecha() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Reporte de Compras");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 500, 50));
    ...
    public void obtenerFecha(){
        ...
        try{
            ...
            ResultSet r= consulta1.executeQuery("select SUM(total_con_iva), SUM(total_sin_iva) from compra where fecha BETWEEN '"+fechaDesde1+"' AND '"+fechaHasta1+"'");
            while(r.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_comprasPorFecha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_comprasPorFecha().setVisible(true);
            }
        });
    }
