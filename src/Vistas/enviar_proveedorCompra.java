...
public class enviar_proveedorCompra extends javax.swing.JFrame {
    int Select;
    String telefono,cedula,nombres,apellidos,direccion;
    
    public enviar_proveedorCompra() {
        initComponents();
        ...
        try{
            ...
            ResultSet r= consulta.executeQuery("select p.cod_proveedor, p.nombre_firma, p.direccion_firma, p.ciudad_firma, p.telefono_firma, p.cuit from proveedor p, compra c where p.cod_proveedor=c.cod_proveedor group by c.cod_proveedor desc");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 1000, 560));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 30, 50, 50));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 32)); // NOI18N
        jLabel2.setText("COMPRAS A PROVEEDORES");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 30, 380, 50));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila>=0){
            ...
            this.dispose();
                frm_proveedores_compra_por_fecha repor = new frm_proveedores_compra_por_fecha();
            repor .setVisible(true);
            repor.setLocationRelativeTo(this);
            repor.recibeProveedor.setText(codigoCliente);
            repor.nombreProveedor.setText(nombreCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enviar_proveedorCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enviar_proveedorCompra().setVisible(true);
            }
        });
    }
