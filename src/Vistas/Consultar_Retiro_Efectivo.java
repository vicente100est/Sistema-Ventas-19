...
public class Consultar_Retiro_Efectivo extends javax.swing.JFrame {
    int Select;
    String nombreCaja,codCaja,fechaApertura,horaApertura,cajaInicial,codigoIngreso;

    public Consultar_Retiro_Efectivo() {
        initComponents();
        ...
        try{
            ...
            ResultSet r= consulta.executeQuery("select cod_retiro,cod_caja,vendedor,fecha,hora,monto_retirado FROM retiro_efectivo ORDER BY cod_retiro");
            int i,j;
            i=0;
            j=0;
    ...
    private void initComponents() {
        ...
        panelImage1.add(txt_recibe, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 640, 37, -1));
        ...
        jLabel9.setText("RETIROS DE EFECTIVO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Retiro_Efectivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_Retiro_Efectivo().setVisible(true);
            }
        });
    }
