 ...
 * @author Hugo
 */
public class frm_proveedores_compra_por_fecha extends javax.swing.JFrame {

    /**
     * Creates new form frm_facturasPorFecha
     */
    public frm_proveedores_compra_por_fecha() {
        initComponents();
    ...
    private void initComponents() {
        ...
        recibeProveedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recibeProveedorActionPerformed(evt);
            }
        });
        jPanel1.add(recibeProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 280, 100, 40));

        jLabel7.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("Reporte de Compras a proveedor");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 660, 50));
        ...
        nombreProveedor.setFont(new java.awt.Font("Calibri", 0, 36)); // NOI18N
        nombreProveedor.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel1.add(nombreProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 660, 50));
    ...
    public void obtenerFecha(){
        ...
        if((mesHasta+1)<10 && (diaHasta>=10)){
            ...
            String codigoCliente=recibeProveedor.getText();
            
            int bandera=0;
            String totalConIva="";
            try{
                Statement consulta1=miconexion.createStatement(); // crea una variable que se encargue del código de sql
                ResultSet r= consulta1.executeQuery("select SUM(total_con_iva) from compra where fecha BETWEEN '"+fechaDesde1+"' AND '"+fechaHasta1+"' AND cod_proveedor='"+codigoCliente+"'");
                while(r.next()){
            ...
            parametros.put("codProveedor",codigoCliente);      
            ...
            parametros.put("totalCompra",totalConIva); 
            try{
                String reporte="proveedoresCompra.jasper";
                JasperPrint informe =JasperFillManager.fillReport(reporte, parametros,miconexion);
                JasperViewer ventanavisor=new JasperViewer(informe,false);
                ventanavisor.setTitle("Reporte Compras por Proveedor");
    ...
    private void recibeProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recibeProveedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recibeProveedorActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_proveedores_compra_por_fecha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_proveedores_compra_por_fecha().setVisible(true);
            }
        });
    }
